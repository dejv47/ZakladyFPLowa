export const bets = [
  ...
  ,
  { id: 16, people: "Dejv i Janek", title: "Rayan Cherki będzie miał minimum 2000 minut w Premier League", pick: "Dejv: TAK • Janek: NIE", amount: 50, note: "Liczymy minuty w Premier League.", mode: "player-minutes-condition", live: { player: "Rayan Cherki", target: 2000, yes: "Dejv", no: "Janek" } },
  { id: 17, people: "Dejv i Łukaszek", title: "Manchester United skończy nad Manchesterem City w lidze", pick: "Łukaszek: TAK • Dejv: NIE", amount: 50, note: "", mode: "standings-versus-condition", live: { a: "Manchester United", b: "Manchester City", yes: "Łukaszek", no: "Dejv" } },
  { id: 18, people: "Dejv i Rudy", title: "Kanadyjka — wszystkie rozgrywki klubowe", pick: "Dejv: Rayan Cherki • Rudy: Bryan Mbeumo", amount: 50, note: "Liczymy G+A we wszystkich rozgrywkach klubowych.", mode: "manual", manualType: "cherki-mbeumo" },
  { id: 19, people: "Rudy i Janek", title: "Kanadyjka w Premier League", pick: "Janek: Ronald Araújo • Rudy: Harry Maguire", amount: 50, note: "Liczymy G+A w Premier League.", mode: "player-ga-versus", live: { a: "Ronald Araujo", b: "Harry Maguire" } }  ,
  {
    id: 20,
    people: "Dejv i Pachana",
    title: "Tottenham skończy w top 8 ligi",
    pick: "Dejv: TAK • Pachana: NIE",
    amount: 50,
    note: "Rozliczenie na podstawie końcowej tabeli Premier League.",
    mode: "standings-condition",
    live: { team: "Tottenham", condition: "top8", yes: "Dejv", no: "Pachana" }
  },
  {
    id: 21,
    people: "Dejv i San Kory",
    title: "Manchester City zdobędzie minimum 12 punktów w następnych 5 meczach ligowych",
    pick: "Dejv: TAK • San Kory: NIE",
    amount: 50,
    note: "Liczymy wyłącznie mecze Premier League: Crystal Palace, Coventry, Manchester United, Sunderland, Liverpool. Cel: minimum 12/15 pkt.",
    mode: "city-five-points",
    live: {
      team: "Manchester City",
      opponents: ["Crystal Palace", "Coventry", "Manchester United", "Sunderland", "Liverpool"],
      target: 12,
      yes: "Dejv",
      no: "San Kory"
    }
  ...
  ,
  { id: 22, people: "Dejv i San Kory", title: "Kto wyżej w lidze", pick: "Dejv: Manchester City • San Kory: Chelsea", amount: 50, note: "Rozliczenie na podstawie końcowej tabeli Premier League.", mode: "standings-versus", live: { a: "Manchester City", b: "Chelsea" } },
  { id: 23, people: "Dejv i San Kory", title: "Kto wyżej w lidze", pick: "Dejv: Manchester City • San Kory: Arsenal", amount: 50, note: "Rozliczenie na podstawie końcowej tabeli Premier League.", mode: "standings-versus", live: { a: "Manchester City", b: "Arsenal" } }
