export const bets = [
  ...
  },
  {
    ...
    pick: "Janek: Carrick • Dejv: Xabi Alonso",
    amount: 50,
    note: "Wymaga wskazania klubów przypisanych do trenerów.",
    mode: "manual"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    title: "Kto wyżej w lidze",
    pick: "Dejv: Don Mareska • Bob: Mikel Bordelas",
    amount: 50,
    note: "Jak któregoś wyjebią wcześniej to się anuluje. Wymaga wskazania klubów.",
    mode: "manual"
  },
  {
    id: 10,
    people: "Dejv i kuchnia",
    title: "Kanadyjka — wszystkie rozgrywki",
    pick: "Dejv: Szeszko • Kuchnia: Watkins",
    amount: 50,
    note: "Wszystkie rozgrywki — pozostawione ręcznie do czasu ustalenia źródła danych.",
    mode: "manual"
  },
  {
    id: 11,
  ...
  },
  {
    ...
    pick: "",
    amount: 30,
    note: "Do uzupełnienia: których dwóch zawodników porównujemy.",
    mode: "manual"
  },
  {
    id: 13,
  ...
  },
  {
    ...
    pick: "Dejv: TAK • Rudy: NIE",
    amount: 50,
    note: "Wymaga wskazania klubu De Zerbiego dla tego zakładu.",
    mode: "manual"
  },
  {
    id: 15,
